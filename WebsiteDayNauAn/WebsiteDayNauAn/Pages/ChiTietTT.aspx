<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietTT.aspx.cs" Inherits="WebsiteDayNauAn.Pages.ChiTietTT" %>
    ...
    <form id="form1" runat="server">
		...
		<div class="slider">
			...
			<div class="container" style="text-align:center">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 style="color:#ff0000"><%= tt.Title %></h3>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<img src="../lib/images/ẩm%20thực/<%=tt.File_anh%>" class="card-img-top" alt="..." style="height:400px" />		
					</div>
				</div>
				<div class="row">
