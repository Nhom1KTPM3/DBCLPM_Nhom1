...
namespace WebsiteDayNauAn.Object
{
    public class MonAn
    {
        ...
        public MonAn(string iD_MonAn, string tenMonAn, string motaMonAn, string pictureMonAn, int t_ChuanBi, int t_NauAn, int t_BoSung, string thanhPhan, string congThuc, int luotXem, string iD_DanhMuc)
        {
            ID_MonAn1 = iD_MonAn;
            TenMonAn1 = tenMonAn;
            MotaMonAn1 = motaMonAn;
            PictureMonAn1 = pictureMonAn;
            T_ChuanBi1 = t_ChuanBi;
            T_NauAn1 = t_NauAn;
            T_BoSung1 = t_BoSung;
            ThanhPhan1 = thanhPhan;
            CongThuc1 = congThuc;
            LuotXem1 = luotXem;
            ID_DanhMuc1 = iD_DanhMuc;
        }
